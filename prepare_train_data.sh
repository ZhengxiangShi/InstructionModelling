...
HF_TOKEN="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"
...
python open_instruct/split_sharegpt_conversations.py \
...
# wget -P data/raw_train/lima/ https://huggingface.co/datasets/GAIR/lima/raw/main/train.jsonl
